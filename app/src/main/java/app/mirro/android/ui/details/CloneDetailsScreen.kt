                ...
                Card(
                    ...
                    Column(
                        ...
                        if (instance.isFrozen) {
                            ...
                            Text(
                                text = instance.runtimeState.label,
                                style = MaterialTheme.typography.labelMedium,
                                color = if (instance.isRuntimeVerified) StatusSupported else MaterialTheme.colorScheme.onSurfaceVariant,
                                fontWeight = FontWeight.Bold
                            )
                        }
                    }
                ...
                Card(
                    ...
                    Column(
                        ...
                        StorageRow(
                            ...
                            value = StorageMetrics.formatBytes(storage?.apkSizeBytes, storage?.isApkEstimated ?: false)
                        )
                        StorageRow(
                            label = stringResource(R.string.details_storage_data),
                            value = StorageMetrics.formatBytes(storage?.dataSizeBytes, storage?.isDataEstimated ?: false)
                        )
                        StorageRow(
                            label = stringResource(R.string.details_storage_cache),
                            value = StorageMetrics.formatBytes(storage?.cacheSizeBytes, storage?.isCacheEstimated ?: false)
                        )
                        Box(
                            modifier = Modifier
                                .fillMaxWidth()
                        ...
                        StorageRow(
                            ...
                            value = StorageMetrics.formatBytes(storage?.totalBytes, storage?.isTotalEstimated ?: false),
                            isBold = true
                        )
                    }
                }
