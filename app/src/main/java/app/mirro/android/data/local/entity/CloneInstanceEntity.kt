...
data class CloneInstanceEntity(
    ...
    val runtimeState: String = CloneRuntimeState.REGISTERED.name,
    ...
    fun toDomainModel(): CloneInstance {
        ...
        val state = try {
            CloneRuntimeState.valueOf(runtimeState)
        } catch (_: Exception) {
            CloneRuntimeState.REGISTERED
        }
        return CloneInstance(
            ...
            runtimeState = state,
            latestFailureStage = latestFailureStage,
    ...
    companion object {
        fun fromDomainModel(instance: CloneInstance): CloneInstanceEntity {
            return CloneInstanceEntity(
                ...
                runtimeState = instance.runtimeState.name,
                latestFailureStage = instance.latestFailureStage,
                latestFailureReason = instance.latestFailureReason
            )
        }
    }
}
