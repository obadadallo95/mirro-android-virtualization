 ...
 * - [PROTECTED]: Application declares device administration, Play Integrity hardware binding, or vendor security restrictions.
...
enum class CompatibilityStatus(
    ...
    companion object {
        val CONTAINER_NOT_TESTED = SUPPORTED
        val CONTAINER_RUNTIME_READY = SUPPORTED
        val CONTAINER_LAUNCH_FAILED = LIMITED
        val WORK_PROFILE_AVAILABLE = SUPPORTED
        val WORK_PROFILE_INSTALL_REQUIRED = LIMITED
        val VERIFIED_WORK_PROFILE = CONTAINER_LAUNCH_VERIFIED
    }
}
